<div class="content">
	<ul class="buttonlist">
		<li>
			<li><a href="<?php
				$link = array('controller' => 'statuses', 'action' => 'add');
				echo $this->Html->url($link); ?>" class="btn btn_book"><span>Adicionar</span></a></li>
		</li>
	</ul>
	<div class="contenttitle radiusbottom0">
		<h2 class="table"><span>Status</span></h2>
	</div>
				...
				<?php foreach ($statuses as $status): ?>
					<tr class="gradeX">
						...
						<td class="center">
							...
							<?php echo $this->Form->postLink(__('Apagar'), array('action' => 'delete', $status['Status']['id']), null, __('Você tem certeza que desja apagar # %s?', $status['Status']['name'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</tbody>
