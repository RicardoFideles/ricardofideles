<div class="content">
	<ul class="buttonlist">
		<li>
			<li><a href="<?php
				$link = array('controller' => 'networks', 'action' => 'add');
				echo $this->Html->url($link); ?>" class="btn btn_book"><span>Adicionar</span></a></li>
		</li>
	</ul>
	<div class="contenttitle radiusbottom0">
		<h2 class="table"><span>Redes Sociais</span></h2>
	</div>
			...
			<tbody>
				<?php foreach ($networks as $network): ?>
					<tr class="gradeX">
						...
						<td><?php echo h($network['Status']['name']); ?></td>
						<td class="center">
							<?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $network['Network']['id'])); ?>
							<?php echo $this->Form->postLink(__('Apagar'), array('action' => 'delete', $network['Network']['id']), null, __('Você tem certeza que desja apagar # %s?', $network['Network']['name'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</tbody>
