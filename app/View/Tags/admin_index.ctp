<div class="content">
	<ul class="buttonlist">
		<li>
			<li><a href="<?php
				$link = array('controller' => 'tags', 'action' => 'add');
	...
	<div class="dataTables_wrapper" id="dyntable_wrapper">
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
			...
			<thead>
				<tr>
					<th class="head1"><?php echo $this->Paginator->sort('Tag');?></th>
				...
				<?php foreach ($tags as $tag): ?>
					<tr class="gradeX">
						...
						<td class="center">
							...
							<?php echo $this->Form->postLink(__('Apagar'), array('action' => 'delete', $tag['Tag']['id']), null, __('Você tem certeza que desja apagar # %s?', $tag['Tag']['name'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</tbody>
