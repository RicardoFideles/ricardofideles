<div class="content">
	<ul class="buttonlist">
		<li>
			<li><a href="<?php
				$link = array('controller' => 'projects', 'action' => 'add');
	...
	<div class="dataTables_wrapper" id="dyntable_wrapper">
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
			...
			<thead>
				<tr>
					<th class="head1"><?php echo $this->Paginator->sort('Projeto');?></th>
				...
				<?php foreach ($projects as $project): ?>
					<tr class="gradeX">
						...
						<td class="center">
							...
							<?php echo $this->Form->postLink(__('Apagar'), array('action' => 'delete', $project['Project']['id']), null, __('Você tem certeza que desja apagar # %s?', $project['Project']['name'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</tbody>
