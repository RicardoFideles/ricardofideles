<div class="content">
	...
	<div class="dataTables_wrapper" id="dyntable_wrapper">
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
			...
			<thead>
				<tr>
					<th class="head1"><?php echo $this->Paginator->sort('Nome em português');?></th>
			...
			<tbody>
				<?php foreach ($news as $news): ?>
					<tr class="gradeX">
						...
						<td class="center">
							<?php echo $this->Html->link(__('Ver'), array('action' => 'view', $news['News']['id'])); ?>
							<?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $news['News']['id'])); ?>
							<?php echo $this->Form->postLink(__('Apagar'), array('action' => 'delete', $news['News']['id']), null, __('Você tem certeza que desja apagar # %s?', $news['News']['name'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</tbody>
